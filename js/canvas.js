...
(function () {
  ...
  function createOrb(canvas, size) {
    ...
    function draw() {
      ...
      glow.addColorStop(0, `rgba(${GOLD.r}, ${GOLD.g}, ${GOLD.b}, 0.12)`);
      glow.addColorStop(0.5, `rgba(${GOLD.r}, ${GOLD.g}, ${GOLD.b}, 0.04)`);
      ...
      coreGrad.addColorStop(0, `rgba(255, 240, 210, ${0.35 + Math.sin(t * 1.5) * 0.1})`);
      ...
      ctx.strokeStyle = `rgba(${GOLD.r}, ${GOLD.g}, ${GOLD.b}, ${0.1 + Math.sin(t) * 0.05})`;
      ctx.lineWidth = 0.8;
      ctx.stroke();
