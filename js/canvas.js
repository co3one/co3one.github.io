...
(function () {
  ...
  if (shareCanvas) {
    ...
    // Color palette — warm amber to deep teal emotional arc
    function drawShareCard() {
      ...
      // Gradient blob 1 — warm gold/amber
      ...
      // Gradient blob 3 — deep rose accent, slower drift
